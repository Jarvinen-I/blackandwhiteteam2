                ...
                <div class="contact__icon-box">
                    <div class="contact__item">
                        ...
                        <div class="contact__text">
                            <a href="tel:<?= CFS()->get('footer_phone'); ?>" target="_blank"><?= CFS()->get('footer_phone'); ?></a></div>
                    </div>
                    <div class="contact__item">
                    ...
                    <div class="contact__item">
                        ...
                        <div class="contact__text"><a href="mailto:<?= CFS()->get('footer_email'); ?>" target="_blank"><?= CFS()->get('footer_email'); ?><a></div>
                    </div>                                                            
                </div>
                <?php the_content(); ?>
            </div>
